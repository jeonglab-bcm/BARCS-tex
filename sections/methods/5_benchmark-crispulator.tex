...
complete-knockout guides, 10\% low-activity guides) was retained.
Transfection representation was 500 cells per guide, with Gaussian phenotype noise of 2; sorting representation was 50 cells per guide, and sequencing depth was 50 reads per guide per sample.  Multiplicity of infection was 0.20 for the
...
each method's own output, so it is unavailable for MAGeCK-MLE.
