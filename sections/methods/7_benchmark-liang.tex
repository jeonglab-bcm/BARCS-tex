...
This benchmark is a same-input sensitivity analysis, not a
likelihood-faithful raw-count comparison.
...
indicator.  K562 was excluded because one deposited day-0 replicate is missing; we did not fit an unmatched trajectory without the replicate block.
