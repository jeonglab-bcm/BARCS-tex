...
The control denominator improved every seed, though unevenly: in the two noncollapsed runs it raised F1 from approximately 0.71 to 0.91, not nearly doubling it.  The held-out null rates
...
So this benchmark is a denominator and moderation ablation within BARCS, not evidence that the beta-binomial sampling model outperforms a valid interaction comparator.  A method-neutral comparison requires a simulation
