...
The value axis spans the full whisker range, so no whisker is cut off at the
panel edge.  (B) F1 across nominal FDR thresholds, with a minor tick at every
threshold and a non-colliding subset labelled.  Control denominators retain
